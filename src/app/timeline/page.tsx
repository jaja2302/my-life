        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {timelineEvents.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">No Timeline Events Yet</h3>
              <p className="text-gray-600 mb-8">Start documenting your love story by adding your first memory!</p>
              <button
